...
<head>
<meta charset="utf-8">
<title>WatchMePlan Event submitted</title>
...
<body>
	...
	<div class="container-xxl py-5 bg-dark hero-header mb-5">
		<div class="container text-center ppt-5 pb-4">
			<!-- <h2 class="text-white mb-3 animated slideInDown">Events Pending for Approval</h2> -->
		</div>
	</div>
	<!-- Navbar & Hero End -->
	...
	<div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
		...
		<div class="col-md-6 bg-dark d-flex align-items-center"
			...
			<div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
				...
				int bill = (int) session.getAttribute("bill");
				...
				<h3 class="text-white mb-4">
					Booking Successful !!<br> <br> Your will be required to
					make the cash payment of Rs.<%=bill%>
					at the venue,<br> 1 hour before the event starts.<br> <br>
					Thank You !!
				</h3>


				<%
					} else if (pay.equals("upi")) {
				%>

				<h3 class="text-white mb-4">
					Payment Successful !!<br> <br> Your tickets have been
					booked successfully.<br> <br> Thank You !!
				</h3>
				...
				String insert = "INSERT INTO tickets (Quantity, UserID, EventID) VALUES (?,?,?)";
				...
				<a href="indexUser.jsp"
					class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Go
					to Home Page</a>
