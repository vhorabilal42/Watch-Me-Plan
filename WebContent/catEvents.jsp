...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
            ...
            String cat = (String)session.getAttribute("scat");
        ...
        <!-- <div class="container-xxl position-relative p-0"> -->
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                 <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"></i>WatchMePlan</h1> 
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <!--     <a href="index.html" class="nav-item nav-link active">Home</a>
                        <a href="#" class="nav-item nav-link">Book Tickets</a>
            ...
            <!-- <div class="container-xxl py-5 bg-dark hero-header mb-5"> -->
                <div class="container my-5 py-5">
                    <!-- <div class="row align-items-center g-5 hero-header mb-5"> -->
                        <div  style="color: #666565;">
                        <!-- <div class="col-lg-6 text-center text-lg-start"> -->
                           <!-- <h1 class="display-3 text-white animated slideInLeft">We Plan,<br>You Have Fun...</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Memorable events don’t just happen. They happen to be our business, whether you organize or attend.</p>
                            <a href="RegisterUser.html" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Sign Up</a>
                            <a href="Login.html" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Log in</a> -->
                        <!-- </div> -->
	...
	try {
		...
		String select = "SELECT * FROM events where Category='"+cat+"'";
		...
		while(rs.next()){
            ...
            <div class="service-item rounded pt-3">
                <div class="p-4">
                    ...
                    <h5><%=rs.getString("EventName") %></h5>
                    <p><%=rs.getString("Details") %></p>
                    <a href='eventDetails.jsp?id=<%=rs.getInt("EventID")%>'>Read More</a>
                </div>
            </div>
       </div> 
		<% 
