	...
	<div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
		...
		<div class="col-md-6 bg-dark d-flex align-items-center"
			...
			<div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
				...
				<form action="bookMsg.jsp" method="post">

					<table border="0" cellpadding="7" cellspacing="7">

						<tr>
							<td><label for="amt"
								style="font-size: 20px; color: white; font-weight: bold;">Total Amount:</label></td>
							<td><input type="text" name="amt" value="<%=bill%>" disabled></td>
						</tr>
						
						<tr>
							<td><label for="upiid"
								style="font-size: 20px; color: white; font-weight: bold;">UPI
									Id:</label></td>
						...
						<tr>
							<td><label for="pin"
								style="font-size: 20px; color: white; font-weight: bold;">PIN</label></td>
							<td><input type="number" name="pin" maxlength="6"></td>
						</tr>
						
						<tr>
							<td><input type="submit" value="Submit" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft"></td>
						</tr>
