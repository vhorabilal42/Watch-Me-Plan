...
<head>
<meta charset="utf-8">
<title>WatchMePlan Update User Profile</title>
		...
		<div class="col-md-6 bg-dark d-flex align-items-center"
			...
			<div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
				...
				<h2 class="text-white mb-4">
					Enter new data only in the fields that you want to update</h2>
				...
				<form action="updateUserData" method="post">
					...
					<table border="0" cellpadding="7" cellspacing="7">
						...
						<tr>
							<td><label for="fname"
								style="font-size: 20px; color: white; font-weight: bold;">First
									Name </label></td>
						...
						<tr>
							<td><label for="lname"
								style="font-size: 20px; color: white; font-weight: bold;">Last
									Name </label></td>
						...
						<tr>
							<td><label for="dob"
								style="font-size: 20px; color: white; font-weight: bold;">Date
									of Birth</label></td>
						...
						<tr>
							<td><label for="contact"
								style="font-size: 20px; color: white; font-weight: bold;">Contact
							</label></td>
						...
						<tr>
							<td><label for="fav"
								style="font-size: 20px; color: white; font-weight: bold;">Current Favourites
							</label></td>
							<td>
							<input type="text" name="fav"
								value="<%=rs.getString("Favourites")%>">
							</td>
						</tr>
						<tr>
							<td><label for="favourites"
								style="font-size: 20px; color: white; font-weight: bold;">New Favourites
							</label></td>
							</td>
							<td style="font-size: 20px; color: white;"><input
								type="checkbox" name="favourites" value="Food">&nbsp;Food&nbsp;
								<input type="checkbox" name="favourites" value="Music">&nbsp;Music&nbsp;
								<input type="checkbox" name="favourites" value="Dance">&nbsp;Dance&nbsp;<br>
								<input type="checkbox" name="favourites" value="Drama">&nbsp;Drama&nbsp;
								<input type="checkbox" name="favourites" value="Sports">&nbsp;Sports&nbsp;
								<input type="checkbox" name="favourites" value="Exhibition">&nbsp;Exhibition<br>
								<input type="checkbox" name="favourites" value="Cultural Events">&nbsp;Cultural
								Event</td>
						</tr>
						<tr>
