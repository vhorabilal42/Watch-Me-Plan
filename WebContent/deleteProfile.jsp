...
<body>
	...
	%>
				<h2 class="text-white mb-4">
					Are you sure ? You want to delete the data ?</h2>
				...
				<form action="deleteUserData" method="post">
					...
					<table border="0" cellpadding="7" cellspacing="7">
						...
						<tr>
						<td>
						<a href='deleteUserData?id=<%=uid%>&f=jsp' class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Yes</a>
						</td>
						
						<td>
						<a href="indexUser.jsp" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">No</a>
						</td>
						</tr>
